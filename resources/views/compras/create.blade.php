...
<div class="card mt-5">
    <div class="card-header">
        <h3 class="nfactura">Nueva compra</h3>
    </div>
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            <form action="{{ route('compras.guardar') }}" method="POST">
                ...
                <table id="productos_table">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="number" name="productos[0][descuento]" step="0.01"
                                oninput="calcularTotal()" required></td>
                        <td><button type="button" onclick="eliminarProducto(this)" class="btn btn-danger" style="color:white"><i
                ...
                <button type="submit" class="btn btn-primary" style="color:white">Guardar Factura</button>
            </form>
