...
<div class="card mt-5">
    <div class="card-header">
        <h5 style="color:white">Lista de productos</h5>
    </div>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 d-flex">
                <a href="{{route('productos.create')}}" class="btn btn-primary me-3">
                    <i class="fa-brands fa-product-hunt ms-2"></i>Nuevo producto</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form id="formulario{{$loop->index}}" action="{{route('productos.destroy', $items)}}"
                                ...
                                @csrf
                                @method('delete')
                                <td><button type="submit" class="btn btn-danger btn-sm" style="color:white"><i
